...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def userUser = Player.findOrSaveWhere(username:"nicogenesio", password:"nicogenesio", nombre:"Nicolas", apellido:"Genesio", email:"nicolas.genesio@mercadolibre.com", fechaNacimiento:new Date(), fechaCreacion:new Date(), codigoDesbloqueo:"123")
